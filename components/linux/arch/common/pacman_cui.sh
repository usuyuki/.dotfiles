...
sudo pacman -S vim inetutils unzip wget make neofetch neovim zellij tree tig ripgrep lazygit gdu bottom git-delta fd peco ranger imagemagick xclip felix-rs xdotool xdotool pacman-contrib cronie less tldr exa speedtest-cli difftastic archlinux-keyring tailscale nmap kwallet-pam xorg-xmodmap gvfs gvfs-smb sshfs traceroute github-cli
